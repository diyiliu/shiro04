            ...
            <tr data-tt-id='${resource.id}' <c:if test="${not resource.rootNode}">data-tt-parent-id='${resource.parentId}'</c:if>>
                ...
                <td>
                    <shiro:hasPermission name="resource:create">
                        ...
                        <a href="${pageContext.request.contextPath}/resource/${resource.id}/appendChild.htm">添加子节点</a>
                        </c:if>
                    </shiro:hasPermission>

                    <shiro:hasPermission name="resource:update">
                        <a href="${pageContext.request.contextPath}/resource/${resource.id}/update.htm">修改</a>
                    </shiro:hasPermission>
...
<script>
    $(function() {
        ...
        $(".deleteBtn").click(function() {
            if(confirm("确认删除吗?")) {
                location.href = "${pageContext.request.contextPath}/resource/"+$(this).data("id")+"/delete.htm";
            }
        });
    });
</script>
